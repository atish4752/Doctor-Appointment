...
const TopDoctors = () => {
  ...
  <p>{item.available?'Available':'Not Available'}</p>
      ...
      <button onClick={()=>{navigate(`/doctors`); scrollTo(0,0)}} className="bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 cursor-pointer hover:scale-105 hover:text-black shadow-md ">more</button>
    </div>
  );
};
